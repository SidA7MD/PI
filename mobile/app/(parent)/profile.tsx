    ...
    return (
        <>
            ...
            >
                        ...
                        <View style={styles.heroStats}>
                            {user?.email && (
                                <View style={styles.statItem}>
                                    ...
                                    <Text style={[styles.statText, { color: colors.text.secondary }]}>{user.email}</Text>
                                </View>
                            )}
                            {user?.phone && (
                                <View style={styles.statItem}>
                ...
                <View style={styles.sectionContainer}>
                    <Text style={[styles.sectionHeader, { color: colors.text.secondary }]}>{t('security').toUpperCase()}</Text>
                    <Card style={styles.menuCard}>
                        <MenuItem 
                ...
                <View style={styles.sectionContainer}>
                    <Text style={[styles.sectionHeader, { color: colors.text.secondary }]}>SUPPORT</Text>
                    <Card style={styles.menuCard}>
                        <MenuItem 
